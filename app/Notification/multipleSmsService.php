...
namespace App\Notification;
 class multipleSmsService  implements NotificationProcess
 {
    public function notification($contact, $msgAndContact){

        $contact;

  $url = "http://sms.aroenterprisebd.com/smsapimany";
  $data = [
    "api_key" => "C20058955e53bd217e7da0.61071270",
    "type" => "text",

    "senderid" => "8809601000500",
    "messages" => json_encode($msgAndContact),
  ];
  $ch = curl_init();
